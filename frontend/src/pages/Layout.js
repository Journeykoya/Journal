...
const Layout = ({ isAuthenticated, profile, signInButton, signOutButton }) => {
      ...
      <div className={`${isOpen ? "" : "hidden"} navbar-menu relative z-50`}>
        ...
        <nav className="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
          ...
          <div>
            <ul>
              <li className="mb-1">
                <a className="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded" href="home">Home</a>
              </li>
              <li className="mb-1">
                <a className="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded" href="aboutus">About Us</a>
              </li>
              <li className="mb-1">
